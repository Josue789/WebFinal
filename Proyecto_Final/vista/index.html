...
<body>
    ...
    <div class="container-fluid scroller" >
        ...
        <div class="container mb-3">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-2  ">
                    <a class=" btn btn-primary" type="submit" href="./RegistroEquipo.html">Nuevo equipo</a>
                </div>
    ...
    <footer >
        <nav class="navbar w-100 text-bg-secondary ">
                <div class="container text-center">
                    <h2 class="row">Patrocinadores</h2>
                    <div class="row">
                      <div class="col-4">
                        <img src="img/omegaup.png" height="20%" alt="">
                      </div>
                      <div class="col-4">
                        <img src="img/SSC-blueprism-2col-logo-cmyk-ai (1).png" height="20%" alt="">
                      </div>
                      <div class="col-4">
                        <img src="img/Untitled.png" height="20%" alt="">
                      </div>
                    </div>
                  </div>
